...
L'idea di cryptoteca è quella di un sistema decentralizzato per il caricamento e noleggio di libri digitali tramite l'uso della tecncologia blockchain e ISPF con costi variabili per il noleggio.
